...
torque = exoNetTorquesLeg(p,PHIs);   % torques generated by the ExoNET
e = TAUsDESIRED(:,1) - torque(:,1);  % ankle torque errors at each operating point
w = TAUsDESIRED(:,2) - torque(:,2);  % knee torque errors at each operating point
