...
text(percentageGaitCycle(63),TAUsDESIRED(63,1)+3,'TOR');
p5 = plot(percentageGaitCycle(end),TAUsDESIRED(end,1),'.k'); % HCR
text(percentageGaitCycle(end)-5,TAUsDESIRED(end,1)+4,'HCR');
...
text(percentageGaitCycle(1)+0.5,TAUsDESIRED(1,2)-1,'HCR');
p4 = plot(percentageGaitCycle(63),TAUsDESIRED(63,2),'.k'); % TOR
text(percentageGaitCycle(63),TAUsDESIRED(63,2)+1,'TOR');
p5 = plot(percentageGaitCycle(end),TAUsDESIRED(end,2),'.k'); % HCR
text(percentageGaitCycle(end)-5,TAUsDESIRED(end,2)+1,'HCR');
legend([p1 p2],'Desired','ExoNET');
box off
