...
TAUs = zeros(size(PHIs)); % initialization
...
for i = 1:size(PHIs,1)
    ...
    for element = 1:EXONET.nElements
        ...
        tau = tau + tauMarionetLeg(PHIs(i,1),BODY.Lengths(1),r,theta,L0);
    end
    ...
    for element = 1:EXONET.nElements
        ...
        tau = tau + tauMarionetLeg(PHIs(i,1)-PHIs(i,2),BODY.Lengths(2),r,theta,L0);
    end
