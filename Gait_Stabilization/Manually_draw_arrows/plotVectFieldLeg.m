...
elseif length(PHIs) > 50
    simpleArrow([-5, 49],[-5, 49]+[scaleTau*10, 0],'k',1.75); % for the legend
    text(-5.5,50,'10 Nm'); % for the legend
else
    simpleArrow([6, 80],[6, 80]+[scaleTau*10, 0],'k',1.75); % for the legend
    text(5.5,81,'10 Nm'); % for the legend
end
